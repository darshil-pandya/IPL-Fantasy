/**
 * Zero fantasy fields on all players in public/IPL-Fantasy/data/players.json and waiver-pool.json.
...
const dataDir = path.join(__dirname, "..", "public", "IPL-Fantasy", "data");
